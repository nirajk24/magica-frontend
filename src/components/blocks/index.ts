...
export function Block({ block, tools, streaming, assetUrls }: BlockProps): ReactElement {
  return createElement(rendererFor(block.type), { block, tools, streaming, assetUrls });
}
